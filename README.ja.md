...
# 動機
プログラミング学習中に、「オブジェク」「プロパティ」などの「カタカナ用語」が次々と現れ、圧倒されたことはないでしょうか。 また、「カタカナ用語」の説明が不足しているために、カタカナ用語の意味が分からず、　　
  
❶カタカナ用語から元英単語を見つける➜  
❷英単語の意味(辞書的定義)を調べる(英or日)➜  
❸その単語のプログラミングにおける意味を理解するために、さらに解説を読む(英or日)  　
  
といった事を何度もしたことはないでしょうか。
